...
public Navio(int numeroPassageiros,int capacidadeTanque,double preco,int numeroTripulantes,String dataLancamento, String nome, String tipoCombustivel01, int potenciaMaxima01, int potenciaAtual01, String tipoCombustivel02, int potenciaMaxima02, int potenciaAtual02){
...
public Navio(String nome, int numeroPassageiros,String tipoCombustivel01, int potenciaMaxima01, int potenciaAtual01, String tipoCombustivel02, int potenciaMaxima02, int potenciaAtual02){
    this.nome = nome;
    this.numeroPassageiros = numeroPassageiros;
    motor1.setTipoCombustivel(tipoCombustivel01);
    motor1.setPotenciaMaxima(potenciaMaxima01);
...
public Navio(String nome, String dataLancamento,String tipoCombustivel01, int potenciaMaxima01, int potenciaAtual01, String tipoCombustivel02, int potenciaMaxima02, int potenciaAtual02){
    this.nome = nome;
    this.dataLancamento = dataLancamento;
    motor1.setTipoCombustivel(tipoCombustivel01);
    motor1.setPotenciaMaxima(potenciaMaxima01);
