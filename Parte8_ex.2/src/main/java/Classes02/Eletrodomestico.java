...
public class Eletrodomestico {
    ...
    public Eletrodomestico (String marca, String modelo, double preco,double comprimentoPorta, double larguraPorta, boolean possuiVidro ){
        this.marca = marca;
        this.modelo = modelo;
        this.preco = preco;
        porta1.setComprimento(comprimentoPorta);
        porta1.setLargura(larguraPorta);
        porta1.setPossuiVidro(possuiVidro);
    }
    public Eletrodomestico(String marca, String modelo,double comprimentoPorta, double larguraPorta, boolean possuiVidro ){
        this.marca = marca;
        this.modelo = modelo;
        porta1.setComprimento(comprimentoPorta);
        porta1.setLargura(larguraPorta);
